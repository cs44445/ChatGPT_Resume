...
import { USER_ROUTING } from "@/store/mutation-types";
...
export function generateIndexRouter(data) {
    let realmenu = {};
    let firstMenu = JSON.parse(sessionStorage.getItem(USER_ROUTING))
        // let firstMenu =  JSON.parse(Vue.ls.get(USER_ROUTING));
    if (firstMenu.length > 0) {
        let menu = firstMenu[0];
    ...
    let indexRouter = [{
        ...
        meta: { title: realmenu.meta.title },
        redirect: realmenu.path,
        // redirect: '/dashboard/analysis',ac1e84437ba1f8c8a102dbceeee66243
        children: [
