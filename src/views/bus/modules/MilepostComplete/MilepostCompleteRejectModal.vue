...
<script>
import MilepostCompleteRejectForm from './MilepostCompleteRejectForm'

export default {
  name: 'MilepostCompleteRejectModal',
  props: ['busApplyRejectForm'],
  components: {
    MilepostCompleteRejectForm
  },
  data() {
    return {
      title: '',
