    ...
    <j-form-container >
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row class="form-content">
          ...
          <a-col :span="12">
            <a-form-model-item label="金额" labelAlign="left" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="money">
          ...
          <a-row type="flex" justify="start" :gutter="{ md: 12, xxl: 16 }">
          <a-col :span="12">
            <a-form-model-item label="税费系数" labelAlign="left" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="taxCoefficient">
              <a-input-number style="width:100%" :disabled="formDisabled" v-model="model.taxCoefficient" placeholder="请输入税费系数"></a-input-number>
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
    ...
    data () {
      return {
        ...
        validatorRules: {
          ...
          taxCoefficient:{required: true, message: '请输入税费系数!'},
