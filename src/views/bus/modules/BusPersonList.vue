        ...
        <a-form layout="inline" @keyup.enter.native="searchQuery">
          <a-row :gutter="24">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="">
                <j-input placeholder="请输入供应商编码" v-model="queryParam.companyCode" class="tablePageQueryCss"></j-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="">
                <j-input placeholder="请输入供应商名称" v-model="queryParam.companyName" class="tablePageQueryCss"></j-input>
              </a-form-item>
            </a-col>
    ...
    <div>
      ...
      <a-table
        ...
        <template slot="companyCode" slot-scope="text, record">
          <a @click="handleEnterpriseDetail(record)">{{record.companyCode}}</a>
        </template>
        <template slot="companyName" slot-scope="text, record">
          <a @click="handleEnterpriseDetail(record)">{{record.companyName}}</a>
        </template>
