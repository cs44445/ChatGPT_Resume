<template>
  <a-card :bordered="false" style="background: #F7F8FA;">
        ...
        <a-form layout="inline" @keyup.enter.native="searchQuery">
          <a-row :gutter="24">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="">
                <j-input placeholder="请输入客户名称" v-model="queryParam.customName" class="tablePageQueryCss"></j-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="">
            ...
            <template v-if="toggleSearchStatus">
              <a-col :xl="6" :lg="7" :md="8" :sm="24">
                <a-form-item label="">
                  <j-dict-select-tag v-model="queryParam.organizeType" placeholder="请选择组织类型" dictCode="organize_type" type="list" class="tablePageQueryCss"></j-dict-select-tag>
                </a-form-item>
              </a-col>
              <a-col :xl="6" :lg="7" :md="8" :sm="24">
                <a-form-item label="">
              ...
              <a-col :xl="6" :lg="7" :md="8" :sm="24">
                <a-form-item label="">
                  <j-dict-select-tag v-model="queryParam.type" placeholder="请选择客户类型" dictCode="econ_type" type="list" class="tablePageQueryCss"></j-dict-select-tag>
                </a-form-item>
              </a-col>
    ...
    <bus-client-modal ref="modalForm" @ok="modalFormOk"></bus-client-modal>
  </a-card>
</template>
...
<script>
  ...
  import BusClientModal from './BusClientModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/bus/busCustom/list",
          delete: "/bus/busCustom/delete",
    ...
    methods: {
      ...
      toDetail(id){
        this.$router.push({ path: '/bus/clientDetails',query: { projectId: id  } })
      },
      resetPassword(id){
