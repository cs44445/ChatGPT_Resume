        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="客户" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="customId">
              <a-select :disabled="formDisabled" v-model="model.customId" placeholder="请选择客户" class="tablePageQueryCss">
                    <!-- <a-select-option value="">请选择</a-select-option> -->
                    <a-select-option v-for="(item, key) in customList" :key="key" :value="item.id">{{item.customName}}</a-select-option>
                   
                  </a-select>
              <!-- <a-input :disabled="formDisabled" v-model="model.customId" placeholder="请输入供应商id"  ></a-input> -->
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules: {
          customId: [{ required: true, message: '请选择客户' }],
        ...
        url: {
          add: "/bus/busCustomPo/add",
          edit: "/bus/busCustomPo/edit",
    ...
    methods: {
      add (customList,projectList) {
        this.edit(this.modelDefault,customList,projectList);
      },
      edit (record,customList,projectList) {
