          ...
          <a-row>
            ...
            <a-col :span="24">
              <a-form-model-item label="相关文档" labelAlign="left" :labelCol="labelCol" :wrapperCol="wrapperCol"
                ...
                <a-upload-dragger name="file" :action="uploadAction" :headers="headers" :data="{ 'biz': '10005' }"
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        uploadCustomFile: '/bus/busCustom/uploadCustomFile'
      },
  ...
  methods: {
    ...
    handleOk() {
      ...
      httpAction(that.url.uploadCustomFile, that.model, 'post').then((res) => {
        if (res.success) {
