<template>
  <a-spin :spinning="confirmLoading">
    <j-form-container>
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail" class="modal-input">
        <a-row class="form-content">
          ...
          <a-col :span="12">
            <a-form-model-item label="金额(元)" labelAlign="left" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="money">
              <a-input-number style="width:100%" :formatter="value => `¥ ${value}`" :disabled="formDisabled"
                v-model="model.money" placeholder="请输入金额(¥)"></a-input-number>
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
            <a-form-model-item label="预算税费系数" labelAlign="left" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="taxCoefficient">
              <a-input-number style="width:100%" :disabled="formDisabled" v-model="model.taxCoefficient"
                placeholder="请输入预算税费系数"></a-input-number>
            </a-form-model-item>
          </a-col>
          </a-row>
          <a-row type="flex" justify="start" :gutter="{ md: 12, xxl: 16 }">
          <a-col :span="12">
            <a-form-model-item label="开始时间" labelAlign="left" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="beginTime">
              <j-date style="width: 100%" v-model="model.beginTime" placeholder="请选择开始时间" showTime
          ...
          <a-col :span="12">
            <a-form-model-item label="结束时间" labelAlign="left" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="endTime">
              <j-date style="width: 100%" v-model="model.endTime" placeholder="请选择结束时间" showTime
                dateFormat="YYYY-MM-DD"></j-date>
            </a-form-model-item>
          </a-col>
          </a-row>
