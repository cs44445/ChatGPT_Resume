<template>
  <a-card :bordered="false" style="background: #F7F8FA;">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="客户">
              <j-input placeholder="请输入客户" v-model="queryParam.customName" class="tablePageQueryCss" allowClear></j-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <bus-billing-report-modal ref="modalForm" @ok="modalFormOk"></bus-billing-report-modal>
  </a-card>
</template>
...
<script>
  ...
  import BusBillingReportModal from './BusBillingReportModal'

  export default {
    name: 'BusBillingReportList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      BusBillingReportModal
    },
    data () {
      return {
        ...
        url: {
          list: "/bus/busCustomPayment/list",
          delete: "/bus/busCustomPayment/delete",
