  ...
  <a-card :bordered="false" style="background: #F7F8FA;">
    ...
    <div class="table-page-search-wrapper" style="display: flex;justify-content: space-between;">
        ...
        <a-form layout="inline" @keyup.enter.native="searchQuery">
          <a-row :gutter="24">
            ...
            <template v-if="toggleSearchStatus">
              <a-col :span="6">
                <a-form-item label="">
                  <j-dict-select-tag v-model="queryParam.ifOverTime" placeholder="请选择是否加班" dictCode="yn" class="tablePageQueryCss"/>
                </a-form-item>
              </a-col>
              <a-col :span="6">
                <a-form-item label="">
                  <j-dict-select-tag v-model="queryParam.overtimeType" placeholder="请选择加班类型" dictCode="overtime_type" class="tablePageQueryCss" />
                </a-form-item>
              </a-col>
              <a-col :span="6">
                <a-form-item label="">
      ...
      <div style="display: flex;gap:10px;">
        <a-button type="primary" icon="download"  @click="handleExportXls('工时明细')">导出</a-button>
      </div>
    </div>
    <!-- 查询区域-END -->
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/bus/countWorkHours/detailsList",
          delete: "/bus/busApplyDateCfg/delete",
          deleteBatch: "/bus/busApplyDateCfg/deleteBatch",
          exportXlsUrl: "/bus/countWorkHours/exportXls",
