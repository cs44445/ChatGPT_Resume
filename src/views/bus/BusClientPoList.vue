<template>
          ...
          <a-row :gutter="24">
            ...
            <a-col :span="6">
              <a-form-item label="客户">
                <a-select v-model="queryParam.customId" placeholder="请选择客户">
                    <!-- <a-select-option value="">请选择</a-select-option> -->
                    <a-select-option v-for="(item, key) in customList" :key="key" :value="item.id">{{item.customName}}</a-select-option>
            ...
            <template v-if="toggleSearchStatus">
              ...
              <a-col :span="8">
                ...
                <j-date :show-time="true" date-format="YYYY-MM-DD" placeholder="请选择订单日期" v-model="queryParam.orderDate"></j-date>
              </a-form-item>
              </a-col>
            </template>
  ...
  <!--      <j-super-query :fieldList="superQueryFieldList" @handleSuperQuery="handleSuperQuery"/>-->
    ...
    <bus-client-po-modal ref="modalForm" :customList="customList" :projectList="projectList" @ok="modalFormOk"></bus-client-po-modal>
  </a-card>
</template>
...
<script>
  ...
  import BusClientPoModal from './modules/BusClientPoModal'  
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/bus/busCustomPo/list",
          delete: "/bus/busCustomPo/delete",
          ...
          customListUrl: '/bus/busCustom/list',
    ...
    methods: {
      getCustomList() {
        getAction(this.url.customListUrl).then((res) => {
            if (res.success) {   
