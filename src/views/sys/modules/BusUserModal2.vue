  ...
  >
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <!--部门分配-->
        <a-form-model-item label="团队" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!departDisabled" prop="selecteddeparts">
          <my-select-depart
           :disabled="disableSubmit"
...
<script>
  ...
  import { addUser,addOrgUser,editUser,queryUserRole,queryall2 } from '@/api/api' 
  import { disabledAuthFilter } from "@/utils/authFilter"
  import { duplicateCheck } from '@/api/api'
  import MySelectDepart from '@/components/jeecgbiz/MySelectDepart'
