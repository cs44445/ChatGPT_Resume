    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="用户账号" :labelCol="labelCol" :wrapperCol="wrapperCol"  prop="username">
          <a-input placeholder="请输入用户账号" v-model="model.username" disabled :readOnly="!!model.id"/>
        </a-form-model-item>
...
<!--        </template>-->
        ...
        <a-form-model-item label="用户姓名" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="realname">
          <a-input placeholder="请输入用户姓名" :disabled="disableSubmit" v-model="model.realname" />
        </a-form-model-item>
        <a-form-model-item label="初始密码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="initialPassword" v-if="model.id">
           <a-input  placeholder="请输入初始密码" v-model="model.initialPassword" disabled/>
        </a-form-model-item>
        <a-form-model-item label="工号" prop="workNo" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-input :disabled="disableSubmit" placeholder="请输入工号" v-model="model.workNo" />
        </a-form-model-item>

        <a-form-model-item label="城市级别" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <j-dict-select-tag :disabled="disableSubmit" v-model="model.cityLevel" placeholder="请选择城市级别" dictCode="city_level" />
        </a-form-model-item>

        <a-form-model-item label="职级" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="post">
...
<!--          </a-radio-group>-->
<!--        </a-form-model-item>-->
<!--        <a-form-model-item label="负责单位" :labelCol="labelCol" :wrapperCol="wrapperCol"  v-show="!departDisabled" prop="departIds">-->
...
<!--        </a-form-model-item>-->
        ...
        <a-form-model-item label="是否有下级单位数据权限" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="ifHasChildData">
          <a-select v-model="model.ifHasChildData" placeholder="请选择" :disabled="disableSubmit">
            <a-select-option value="1">是</a-select-option>
            <a-select-option value="2">否</a-select-option>
          </a-select>
        </a-form-model-item> -->
        ...
        <a-form-model-item label="入职时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="inductionTime">
          <!-- <a-input  placeholder="请输入入职时间" v-model="model.inductionTime"  :disabled="disableSubmit"/> -->
<!--          <a-date-picker -->
<!--          @change="onChange" -->
<!--          placeholder="请输入入职时间" -->
<!--          v-model="model.inductionTime"  -->
<!--          :disabled="disableSubmit"-->
<!--          style="width:100%;"/>-->
          <j-date placeholder="请输入入职时间" :disabled="disableSubmit" v-model="model.inductionTime"  style="width: 100%" />
        </a-form-model-item>
...
<!--        </a-form-model-item>-->
       ...
       <a-form-model-item label="简历" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="resume">
         <j-upload :file-type="'10002'" v-model="model.resume" :showUploadBtn="!disableSubmit"  :disabled="disableSubmit"></j-upload>
       </a-form-model-item>
    ...
    data () {
      return {
        ...
        validatorRules:{
          ...
          post:[{ required: true, message: '请选择职级' }],
          phone: [{required: false}, {validator: this.validatePhone}],
