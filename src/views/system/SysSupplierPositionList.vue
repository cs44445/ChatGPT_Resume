      ...
      <div style="width: 70%;">
        <a-form layout="inline" @keyup.enter.native="searchQuery">
          <a-row :gutter="24">
            <a-col :span="6">
                <a-form-item label="">
                  <j-input v-model="queryParam.dutiesName" placeholder="请输入职位" class="tablePageQueryCss"></j-input>
                </a-form-item>
              </a-col>
            <!-- <a-col :md="6" :sm="8">
...
<!-- :rowSelection="{selectedRowKeys: selectedRowKeys, onChange: onSelectChange}" -->
    ...
    <!-- 表单区域 -->
    <sys-supplier-position-modal ref="modalForm" @ok="modalFormOk"></sys-supplier-position-modal>
  </a-card>
</template>

<script>
  // import SysSupplierPositionModal from './modules/SysSupplierPositionModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import JDictSelectTag from '@/components/dict/JDictSelectTag'
import SysSupplierPositionModal from './modules/SysSupplierPositionModal.vue'

  export default {
    name: 'SysSupplierPositionList',
    mixins: [JeecgListMixin],
    components: {
      SysSupplierPositionModal,
      JDictSelectTag
    },
    data() {
      return {
        ...
        url: {
          list: "/bus/busCompanyDuties/list",
          delete: "/bus/busCompanyDuties/delete",
          deleteBatch: "/bus/busCompanyDuties/deleteBatch",
          exportXlsUrl: "/bus/busCompanyDuties/exportXls",
          importExcelUrl: "bus/busCompanyDuties/importExcel",
        },
      }
    },
    computed: {
