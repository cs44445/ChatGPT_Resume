...
export const constantRouterMap = [{
        ...
        children: [{
            ...
            },
            {
                ...
                name: 'register',
                component: () =>
                    import ( /* webpackChunkName: "user" */ '@/views/user/register/Register')
            },
            // {
            //     path: 'register-result',
            //     name: 'registerResult',
            //     component: () =>
            //         import ( /* webpackChunkName: "user" */ '@/views/user/register/RegisterResult')
            // },
            // {
            //     path: 'alteration',
            //     name: 'alteration',
    ...
    // {
    //   path: '/taskDetails',
    //   component: () => import('@/views/bus/taskDetails')
    // },
    {
        path: '/404',
        component: () =>
