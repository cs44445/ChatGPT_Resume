<template>
  <div class="components-input-demo-presuffix">
    <!---->
    <a-input @click="openModal" placeholder="请点击选择团队" v-model="departNames" readOnly :disabled="disabled">
      <a-icon slot="prefix" type="cluster" title="团队选择控件"/>
      <a-icon v-if="departIds" slot="suffix" type="close-circle" @click="handleEmpty" title="清空"/>
    </a-input>

    <my-select-depart-modal
...
<script>
  import MySelectDepartModal from './modal/MySelectDepartModal'
  export default {
    name: 'JSelectDepart',
    components:{
      MySelectDepartModal
