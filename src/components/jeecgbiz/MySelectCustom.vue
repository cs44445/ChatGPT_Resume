<template>
  <div class="components-input-demo-presuffix">
    <!---->
    <a-input @click="openModal" placeholder="请点击选择客户公司" v-model="departNames" readOnly :disabled="disabled">
      <a-icon slot="prefix" type="cluster" title="客户公司选择控件"/>
      <a-icon v-if="departIds" slot="suffix" type="close-circle" @click="handleEmpty" title="清空"/>
    </a-input>

    <my-select-custom-modal
...
<script>
  import MySelectCustomModal from './modal/MySelectCustomModal'
  export default {
    name: 'JSelectDepart',
    components:{
      MySelectCustomModal
