...
<script>
  ...
  export default {
    ...
    data() {
      return {
        url: { list: '/sys/user/userList' },
        columns: [
          { title: '用户名', align: 'center', width: '30%', dataIndex: 'username' },
          { title: '姓名', align: 'center', width: '30%', widthRight: '30%', dataIndex: 'realname' },
          { title: '电话', align: 'center', width: '30%', dataIndex: 'phone' },
