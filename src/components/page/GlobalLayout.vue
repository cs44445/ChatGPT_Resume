    ...
    <template v-if="layoutMode === 'sidemenu'">
      ...
      >
        <side-menu
          ...
          v-if="device === 'mobile'"
          :menus="menus"
          @menuSelect="menuSelect"  @toggle="toggle"
      ...
      <side-menu
        ...
        mode="inline"
        :menus="menus"
        @menuSelect="myMenuSelect"  @toggle="toggle"
        @updateMenuTitle="handleUpdateMenuTitle"
        :theme="navTheme"
        :collapsed="collapsed"
        :collapsible="true"></side-menu>
...
<style lang="less">
  body {
    ...
    // }
    .test > .ant-select-dropdown-menu-item-group-title{
      color: #000;
      font-weight: bold;
      height: 45px;
      padding: 0 15px;
    ...
    .test > .ant-select-dropdown-menu-item-group-list {
      display: flex;
      flex-wrap: wrap;
